...
class DeepLabv3Plus_with_rep(nn.Module):
    def __init__(self, orig_resnet, dilate_scale=16, num_classes=21, output_dim=256):
        super(DeepLabv3Plus_with_rep, self).__init__()
        if dilate_scale == 8:
            orig_resnet.layer3.apply(partial(self._nostride_dilate, dilate=2))
            orig_resnet.layer4.apply(partial(self._nostride_dilate, dilate=4))
            aspp_dilate = [12, 24, 36]
...
class DeepLabv3Plus_E(nn.Module):
    def __init__(self, orig_resnet, dilate_scale=16, num_classes=21, output_dim=256):
        super(DeepLabv3Plus_E, self).__init__()
        if dilate_scale == 8:
            orig_resnet.layer3.apply(partial(self._nostride_dilate, dilate=2))
            orig_resnet.layer4.apply(partial(self._nostride_dilate, dilate=4))
            aspp_dilate = [12, 24, 36]
    ...
    def forward(self, x):
        ...
        return x_low, feature

class DeepLabv3Plus_r(nn.Module):
    def __init__(self, orig_resnet, dilate_scale=16, num_classes=21, output_dim=256):
        super(DeepLabv3Plus_r, self).__init__()
        if dilate_scale == 8:
            orig_resnet.layer3.apply(partial(self._nostride_dilate, dilate=2))
            orig_resnet.layer4.apply(partial(self._nostride_dilate, dilate=4))
            aspp_dilate = [12, 24, 36]
